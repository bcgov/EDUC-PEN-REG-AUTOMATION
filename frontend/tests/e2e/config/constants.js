...
module.exports.staffLoginUrl = 'https://student-admin-' + module.exports.pen_namespace + '-' + module.exports.pen_environment + '.pathfinder.gov.bc.ca/';
module.exports.mailsacUrl = 'https://mailsac.com/login';
module.exports.getTokenUrl = 'https://' + module.exports.token_namespace + '-' + module.exports.token_environment + '.pathfinder.gov.bc.ca/auth/realms/master/protocol/openid-connect/token';
module.exports.pagenatedUrl = 'https://pen-request-api-' + module.exports.token_namespace + '-' + module.exports.token_environment + '.pathfinder.gov.bc.ca/paginated';
module.exports.penRequestApiUrl = 'https://pen-request-api-' + module.exports.token_namespace + '-' + module.exports.token_environment + '.pathfinder.gov.bc.ca/';
module.exports.studentApiUrl = 'https://student-api-' + module.exports.token_namespace + '-' + module.exports.token_environment + '.pathfinder.gov.bc.ca/'
module.exports.digitalIdApiUrl = 'https://digitalid-api-' + module.exports.token_namespace + '-' + module.exports.token_environment + '.pathfinder.gov.bc.ca/'
module.exports.studentProfileApiUrl = 'https://student-profile-api-' + module.exports.token_namespace + '-' + module.exports.token_environment + '.pathfinder.gov.bc.ca/'
module.exports.penMatchApiUrl = 'https://pen-match-api-' + module.exports.pen_namespace + '-' + module.exports.token_environment + '.pathfinder.gov.bc.ca/api/v1/pen-match'
